        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
            ...
            <div className="lg:col-span-6">
              <div className="relative sticky top-28 overflow-hidden bg-gradient-to-br from-rose-100/70 via-pink-50/50 to-stone-100/80 dark:from-zinc-900 dark:to-zinc-800 rounded-3xl p-10 sm:p-16 border border-rose-100 dark:border-zinc-800 flex flex-col items-center justify-center text-center shadow-xs aspect-square sm:aspect-auto">
